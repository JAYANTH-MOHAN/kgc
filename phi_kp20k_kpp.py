...
llm = LLM(model="microsoft/Phi-3-mini-128k-instruct",gpu_memory_utilization=0.98,max_model_len=4096,tensor_parallel_size=2)  
...
file_path = os.path.join(output_dir, "Phi_latest_final_with_kpp.txt")
